                        ...
                        <div class="dashboard_contentMain">
                                ...
                                {   /*Only adminsitrator can add*/
                                    if($_SESSION['AccType'] == "SYSTEM ADMINISTRATOR")
                                    {
                                        if($_POST['btnSubmit'])
                                        {
                                            if($_POST['txtCat']!="")
                                                {
                                                    $AddQuery = "INSERT INTO itemCat (categoryDetail, `status`) VALUES ('".strtoupper(trim($_POST['txtCat']))."', 'ACTIVE')";
                            ...
                            ?>
                                    ...
                                    <form method="post" action="">
                                            <fieldset id="info">
                                                <legend><h1>Add Item Categry</h1></legend><br>
                                                <div class="form-margin">
                                                    <label for="txtCat">Category:</label>
                                                    <input type="text" id="txtCat" name="txtCat"><br><br>
                                                </div>
